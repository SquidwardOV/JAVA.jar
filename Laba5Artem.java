...
/**
 * Интерфейс для примера, представляющий некоторую функциональность.
 */
...
/**
 * Интерфейс, представляющий некоторую другую функциональность относительно первого интерфейса.
 */
